...
export type Project = { id: string; title: string; createdAt: string; status: Status; stepState: "IDLE" | "RUNNING" | "FAILED"; activeStep?: StepKey; stepStartedAt?: string; lastError?: string; bookPreview: string; style?: string; characters: Asset[]; chapters: Asset[] };
