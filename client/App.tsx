...
const progressSubtitle = (status: Status) => { const count = completedCount(status); return status === "DONE" ? "All 5 steps complete" : count === 0 ? "Not started yet" : `${stepMeta.slice(0, count).map((item) => item.label).join(" + ")} done`; };
